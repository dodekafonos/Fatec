...
def date_fashion(eu, par):
  ...
  return 2 if eu > 8 or par > 8 else 1
...
def pego_correndo(speed, is_birthday):
  if speed <= 60 and not is_birthday or speed <= 65 and is_birthday: return 0
  if 60 < speed <= 80 and not is_birthday or 65 < speed <= 85 and is_birthday: return 1
  if speed > 80 and not is_birthday or speed > 85 and is_birthday: return 2
